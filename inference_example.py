...
def fairness_analysis_example():
    ...
    models = {
        "FairTFM-0.7": FairTFMClassifier(device=device),
        "FairTFM-25": FairTFMClassifier(model="https://huggingface.co/patrikken/FairTFM/blob/main/FairTFM-25-epoch_10000.pt",device=device),
